...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification
{
    ...
    _pointer = [[DefaultPointer alloc] init];
	...
	[_pointerOverlayWindow setBackgroundColor:[NSColor colorWithPatternImage:[_pointer imageForState:kPointerMouseStateMoved]]];
...
- (void)mouseDown
{
	[_pointerOverlayWindow setBackgroundColor:[NSColor colorWithPatternImage:[_pointer imageForState:kPointerMouseStateDown]]];
}

- (void)mouseUp
{
	[_pointerOverlayWindow setBackgroundColor:[NSColor colorWithPatternImage:[_pointer imageForState:kPointerMouseStateUp]]];
}
...
- (void)mouseDragged
{
    [_pointerOverlayWindow setBackgroundColor:[NSColor colorWithPatternImage:[_pointer imageForState:kPointerMouseStateDragged]]];
	[self updateWindowPosition];
}
...
{
    AppDelegate * delegate= (__bridge AppDelegate *) contextData;
